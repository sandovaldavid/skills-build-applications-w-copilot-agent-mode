...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS('Successfully created teams and added members'))
        ...
        self.stdout.write(self.style.SUCCESS('Successfully created leaderboard entries'))
